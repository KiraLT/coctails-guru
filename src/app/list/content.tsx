...
export default function Content(): JSX.Element {
    ...
    return <>
        <div className="flex items-center justify-between mb-4">
            <h1 className="text-xl md:text-4xl">{list.name || 'Unnamed list'}</h1>
            <div className="whitespace-nowrap ml-2">
                <Button color='primary' variant='outline' startIcon={<FaShareFromSquare />} onClick={() => {
                    shareDialog.handleShow()
                }} className='m-1'>
                    <span className="hidden md:block">Share</span>
                </Button>
                <Button color='secondary' variant='outline' startIcon={<FaPenToSquare />} onClick={() => {
