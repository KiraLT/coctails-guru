...
export function Layout<T extends Thing>({
    ...
    return (
        <>
            ...
            {!!process.env.NEXT_PUBLIC_GA_ID && <Script src={`https://www.googletagmanager.com/gtag/js?id=${process.env.NEXT_PUBLIC_GA_ID}`} />}
            {!!process.env.NEXT_PUBLIC_GA_ID && <Script id="google-analytics">
                {`
